var ImgCliper = require('./imgcliper.js');
/**
* 
* 图片上传+裁剪功能类
* fis语法依赖 _canvasresize/main.js
* @require _canvasresize/main.js
*
**/
var not_support = [
    /UCBrowser\/10\.6\.0\.620/i
];
var ImgUpload = module.exports = function(el, opt) {

    for(var i = 0; i< not_support.length; i++){
        if( not_support[i].exec(navigator.userAgent) ){
            alert('发现您当前使用的浏览器上传图片有故障。\n请尝试更换浏览器访问本页');
        }
    }
